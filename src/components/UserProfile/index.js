...
class UserProfile extends Component {
  ...
  getUpdatedData = eachItem => ({
    followerCount: eachItem.user_details.followers_count,
    followingCount: eachItem.user_details.following_count,
    id: eachItem.user_details.id,
    postCount: eachItem.user_details.posts_count,
    profilePic: eachItem.user_details.profile_pic,
    userBio: eachItem.user_details.user_bio,
    userId: eachItem.user_details.user_id,
    userName: eachItem.user_details.user_name,
  })
  ...
  renderFailureView = () => (
    <div className="failure-container">
      <img
        ...
        src="https://res.cloudinary.com/djbs4yqbz/image/upload/v1684138286/failure_Image_qvteip.png"
        alt="failure view"
      />
